...
public class MappedListFieldTest {
    ...
    public void setUp() throws RegisterBlueprintException {
        ...
        modelFactory.registerBlueprint("bad", badCarBlueprint);
        modelFactory.registerBlueprint(coolCarBlueprint);
    ...
    public void testEmptyListDoesNotInjectBlueprint() throws CreateModelException {
        ...
        assertEquals(2, factoryWheel.getVariants().size());
    }
    ...
    @Test
    public void testMappedListByAliases() throws CreateModelException {
        Driver driver = modelFactory.createModel(Driver.class);

        assertEquals("size of list defines in array of aliases", 3, driver.getFavoriteCars().size());
    }
}
